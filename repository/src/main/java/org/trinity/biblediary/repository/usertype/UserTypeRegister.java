...
@TypeDefs({
        ...
        @TypeDef(typeClass = MessageUserType.class, parameters = @Parameter(name = "class", value = "org.trinity.biblediary.common.message.lookup.TimeZone"), defaultForType = TimeZone.class),
        @TypeDef(typeClass = MessageUserType.class, parameters = @Parameter(name = "class", value = "org.trinity.biblediary.common.message.lookup.BibleVolume"), defaultForType = BibleVolume.class),
